...
import (
	...
	"github.com/BrobridgeOrg/gravity-transmitter-mssql/pkg/app"
...
func (subscriber *Subscriber) Init() error {
	...
	err = subscriber.subscriber.Register(gravity_subscriber.SubscriberType_Transmitter, "mssql", subscriberID, subscriberName)
	if err != nil {
		return err
	}
